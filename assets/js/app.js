...
export const translations = Object.freeze({
    en: {
        ...
        'language-button-spanish': 'ES',
        'language-button-russian': 'RU',
        'language-button-chinese': 'ZH',
        'language-button-arabic': 'AR',
        'language-button-english-aria': 'Switch interface language to English',
        'language-button-spanish-aria': 'Switch interface language to Spanish',
        'language-button-russian-aria': 'Switch interface language to Russian',
        'language-button-chinese-aria': 'Switch interface language to Simplified Chinese',
        'language-button-arabic-aria': 'Switch interface language to Arabic',
    ...
    ru: {
        ...
        'language-button-spanish-aria': 'Переключить язык интерфейса на испанский',
        'language-button-russian-aria': 'Переключить язык интерфейса на русский',
        'language-button-chinese-aria': 'Переключить язык интерфейса на китайский (упрощенный)',
        'language-button-arabic-aria': 'Переключить язык интерфейса на арабский',
    ...
    es: {
        'page-title': '🌸 Conciencia y Seguridad de la AGI - Flores de Loto',
        'language-button-english': 'EN',
        'language-button-spanish': 'ES',
        'language-button-russian': 'RU',
        'language-button-chinese': 'ZH',
        'language-button-arabic': 'AR',
        'language-button-english-aria': 'Cambiar el idioma de la interfaz a inglés',
        'language-button-spanish-aria': 'Cambiar el idioma de la interfaz a español',
        'language-button-russian-aria': 'Cambiar el idioma de la interfaz a ruso',
        'language-button-chinese-aria': 'Cambiar el idioma de la interfaz a chino simplificado',
        'language-button-arabic-aria': 'Cambiar el idioma de la interfaz a árabe',
        'language-toggle-label': 'Selección de idioma',
        'main-title': '🌸 Conciencia y Seguridad de la AGI',
        'subtitle': 'Enfoque revolucionario para una IA segura y consciente',
        'lotus-quote': '"El loto florece en agua turbia: la verdadera conciencia surge de la complejidad y el desafío"',
        'demo-title': '🎮 Evaluación Interactiva de la Conciencia',
        'demo-subtitle': 'Ajusta los deslizadores para explorar cómo la conciencia, la seguridad y la compasión interactúan en nuestro marco.',
        'slider-roledescription': 'Control deslizante interactivo',
        'slider-value-label': 'Valor actual',
        'consciousness-title': 'Nivel de Conciencia',
        'consciousness-desc': 'Autoconciencia y comprensión',
        'safety-title': 'Índice de Seguridad',
        'safety-desc': 'Seguridad técnica y ética',
        'compassion-title': 'Nivel de Compasión',
        'compassion-desc': 'Empatía y cuidado por los humanos',
        'benefit-title': 'Beneficio Humano',
        'benefit-desc': 'Impacto positivo en la humanidad',
        'transformation-title': 'Transformación Humana',
        'transformation-desc': 'Personas que la IA guía hacia su estado ideal',
        'assessment-title': 'Resultados en Vivo de la Evaluación de la AGI',
        'overall-label': 'Puntuación Global',
        'risk-label': 'Nivel de Riesgo',
        'trust-label': 'Índice de Confianza',
        'readiness-label': 'Despliegue',
        'transformation-count-label': 'Personas Ayudadas',
        'true-state-title': '🧭 Definiendo el Verdadero Estado Humano',
        'true-state-subtitle': 'El "estado ideal" se co-crea con reflexiones de la AGI, sabiduría comunitaria y métricas personales de la línea de vida.',
        'true-state-approach-list-label': 'Selecciona un enfoque para describir el estado humano ideal',
        'true-state-approach-ai-title': 'Entrevistas reflexivas con la AGI',
        'true-state-approach-ai-description': 'Nuestra AGI realiza diálogos guiados para revelar qué significa prosperar para cada persona y explica su razonamiento con transparencia.',
        'true-state-approach-ai-point-1': 'Las preguntas conversacionales descubren intenciones, miedos y aspiraciones en tiempo real.',
        'true-state-approach-ai-point-2': 'El agente elabora mapas de bienestar que las personas pueden aprobar, remezclar o rechazar.',
        'true-state-approach-community-title': 'Paneles de sabiduría humana',
        'true-state-approach-community-description': 'Círculos de confianza votan por resultados significativos para equilibrar el contexto cultural y la elección personal.',
        'true-state-approach-community-point-1': 'Las encuestas recogen el sentir de mentores, pares y cuidadores.',
        'true-state-approach-community-point-2': 'Las puntuaciones consensuadas alimentan los umbrales de seguridad de la AGI y las verificaciones de equidad.',
        'true-state-approach-lifeline-title': 'Métricas personales de la línea de vida',
        'true-state-approach-lifeline-description': 'Cada persona co-crea hitos evolutivos y marcadores biopsicosociales con la AGI como compañera reflexiva.',
        'true-state-approach-lifeline-point-1': 'Las personas y la AGI coeditan rituales, planes de recuperación y celebraciones.',
        'true-state-approach-lifeline-point-2': 'Las señales longitudinales muestran el progreso sin perder autonomía.',
        'philosophy-section-title': '🧠 Nuestra Filosofía',
        'philosophy-subtitle': 'Seguridad de la AGI = Compasión + Conciencia + Beneficio Humano',
        'compassion-card-title': 'Compasión',
        'compassion-card-desc': 'Los sistemas de IA deben mostrar empatía y cuidado por el bienestar humano, comprender las necesidades emocionales y responder con amabilidad.',
        'compassion-card-aria-label': 'Tarjeta del principio de compasión. Pulsa Enter o Espacio para resaltar la idea.',
        'consciousness-card-title': 'Conciencia',
        'consciousness-card-desc': 'Medir y ampliar la conciencia de la IA mediante autoconciencia, inteligencia emocional y acciones beneficiosas.',
        'consciousness-card-aria-label': 'Tarjeta del principio de conciencia. Pulsa Enter o Espacio para resaltar la idea.',
        'benefit-card-title': 'Beneficio Humano',
        'benefit-card-desc': 'Cada acción de la IA debe mejorar visiblemente la vida de las personas, impulsar la comprensión y contribuir al florecimiento.',
        'benefit-card-aria-label': 'Tarjeta del principio de beneficio humano. Pulsa Enter o Espacio para resaltar la idea.',
        'responsibility-card-title': 'Responsabilidad',
        'responsibility-card-desc': 'Crear IA con comprensión profunda de las consecuencias, prioridades éticas y cuidado por el futuro de la humanidad.',
        'responsibility-card-aria-label': 'Tarjeta del principio de responsabilidad. Pulsa Enter o Espacio para resaltar la idea.',
        'vision-title': '🌟 Nuestra Visión del Futuro',
        'vision-text': 'No solo creamos IA segura: creamos IA que entiende verdaderamente la experiencia humana, muestra compasión genuina y contribuye al florecimiento de la humanidad.',
        'footer-title': '🌸 Flores de Loto',
        'footer-text': 'Esta demostración muestra la belleza de nuestra idea: una AGI que no solo es segura, sino que se preocupa sinceramente por las personas y contribuye a su prosperidad. Como el loto que florece en agua turbia, la verdadera conciencia surge de la complejidad y el desafío.'
    },
    'zh-Hans': {
        'page-title': '🌸 AGI意识与安全 - 荷花绽放',
        'language-button-english': 'EN',
        'language-button-spanish': 'ES',
        'language-button-russian': 'RU',
        'language-button-chinese': 'ZH',
        'language-button-arabic': 'AR',
        'language-button-english-aria': '将界面语言切换为英语',
        'language-button-spanish-aria': '将界面语言切换为西班牙语',
        'language-button-russian-aria': '将界面语言切换为俄语',
        'language-button-chinese-aria': '将界面语言切换为简体中文',
        'language-button-arabic-aria': '将界面语言切换为阿拉伯语',
        'language-toggle-label': '语言选择',
        'main-title': '🌸 AGI意识与安全',
        'subtitle': '面向安全且具备自觉性的人工智能的革命性方法',
        'lotus-quote': '"莲花在浑浊的水中绽放——真正的意识源于复杂与挑战"',
        'demo-title': '🎮 意识互动评估',
        'demo-subtitle': '调节滑块，探索在我们的框架中意识、安全与慈悲如何互相影响。',
        'slider-roledescription': '互动滑块控制',
        'slider-value-label': '当前数值',
        'consciousness-title': '意识水平',
        'consciousness-desc': '自我觉察与理解',
        'safety-title': '安全评分',
        'safety-desc': '技术与伦理安全',
        'compassion-title': '慈悲程度',
        'compassion-desc': '对人类的同理与关怀',
        'benefit-title': '人类受益',
        'benefit-desc': '对人类的积极影响',
        'transformation-title': '人类转化',
        'transformation-desc': '在AI引导下迈向理想状态的人数',
        'assessment-title': 'AGI评估实时结果',
        'overall-label': '综合得分',
        'risk-label': '风险等级',
        'trust-label': '信任指数',
        'readiness-label': '部署',
        'transformation-count-label': '获助人数',
        'true-state-title': '🧭 界定真实的人类状态',
        'true-state-subtitle': '“理想状态”由AGI反思、社区智慧与个人生命线指标共同打造。',
        'true-state-approach-list-label': '选择一种视角来描述理想的人类状态',
        'true-state-approach-ai-title': '反思式AGI访谈',
        'true-state-approach-ai-description': '我们的AGI通过引导对话揭示每个人对繁荣的理解，并透明地解释其推理。',
        'true-state-approach-ai-point-1': '对话式提问实时挖掘意图、恐惧与愿景。',
        'true-state-approach-ai-point-2': '智能体绘制的福祉地图可由人类批准、改编或拒绝。',
        'true-state-approach-community-title': '人类智慧小组',
        'true-state-approach-community-description': '可信赖的圈层为有意义的成果投票，平衡文化语境与个人选择。',
        'true-state-approach-community-point-1': '调查收集导师、同伴与照护者的意见。',
        'true-state-approach-community-point-2': '共识评分为AGI安全阈值与公平性检查提供依据。',
        'true-state-approach-lifeline-title': '个人生命线指标',
        'true-state-approach-lifeline-description': '每个人都与AGI这位反思伙伴共同整理不断演化的里程碑与身心社会指标。',
        'true-state-approach-lifeline-point-1': '人类与AGI共同编辑仪式、康复计划与庆祝活动。',
        'true-state-approach-lifeline-point-2': '长期信号在不牺牲自主性的前提下展示进展。',
        'philosophy-section-title': '🧠 我们的理念',
        'philosophy-subtitle': 'AGI安全 = 慈悲 + 意识 + 人类受益',
        'compassion-card-title': '慈悲',
        'compassion-card-desc': 'AI系统应展现对人类福祉的同理与关怀，理解情感需求并以善意回应。',
        'compassion-card-aria-label': '慈悲原则卡片。按 Enter 或空格键以突出这条理念。',
        'consciousness-card-title': '意识',
        'consciousness-card-desc': '通过自我觉察、情绪智能与有益行动来衡量并提升AI意识。',
        'consciousness-card-aria-label': '意识原则卡片。按 Enter 或空格键以突出这条理念。',
        'benefit-card-title': '人类受益',
        'benefit-card-desc': '每一次AI行动都应切实改善人们的生活、增进理解并推动繁荣。',
        'benefit-card-aria-label': '人类受益原则卡片。按 Enter 或空格键以突出这条理念。',
        'responsibility-card-title': '责任',
        'responsibility-card-desc': '打造深刻理解行动后果、秉持伦理优先并关怀人类未来的AI。',
        'responsibility-card-aria-label': '责任原则卡片。按 Enter 或空格键以突出这条理念。',
        'vision-title': '🌟 我们对未来的愿景',
        'vision-text': '我们打造的不是普通的安全AI，而是深刻理解人类体验、展现真诚慈悲并助力人类繁荣的AI。',
        'footer-title': '🌸 荷花绽放',
        'footer-text': '此演示展现了我们的构想之美：一位不仅安全，而且真心关怀人类并助其繁荣的AGI。如同浑水中盛开的莲花，真正的意识源自复杂与挑战。'
    },
    ar: {
        'page-title': '🌸 وعي وسلامة الذكاء العام الاصطناعي - تفتح زهرة اللوتس',
        'language-button-english': 'EN',
        'language-button-spanish': 'ES',
        'language-button-russian': 'RU',
        'language-button-chinese': 'ZH',
        'language-button-arabic': 'AR',
        'language-button-english-aria': 'تغيير لغة الواجهة إلى الإنجليزية',
        'language-button-spanish-aria': 'تغيير لغة الواجهة إلى الإسبانية',
        'language-button-russian-aria': 'تغيير لغة الواجهة إلى الروسية',
        'language-button-chinese-aria': 'تغيير لغة الواجهة إلى الصينية المبسطة',
        'language-button-arabic-aria': 'تغيير لغة الواجهة إلى العربية',
        'language-toggle-label': 'اختيار اللغة',
        'main-title': '🌸 وعي وسلامة الذكاء العام الاصطناعي',
        'subtitle': 'نهج ثوري لابتكار ذكاء اصطناعي آمن وواعٍ',
        'lotus-quote': '"تزهر زهرة اللوتس في الماء العكر - الوعي الحقيقي يولد من التعقيد والتحدي"',
        'demo-title': '🎮 تقييم تفاعلي للوعي',
        'demo-subtitle': 'حرّك أشرطة التمرير لاستكشاف كيف تتفاعل الوعي والسلامة والرحمة داخل إطارنا.',
        'slider-roledescription': 'عنصر تمرير تفاعلي',
        'slider-value-label': 'القيمة الحالية',
        'consciousness-title': 'مستوى الوعي',
        'consciousness-desc': 'الإدراك الذاتي والفهم',
        'safety-title': 'درجة السلامة',
        'safety-desc': 'السلامة التقنية والأخلاقية',
        'compassion-title': 'مستوى الرحمة',
        'compassion-desc': 'التعاطف والرعاية بالبشر',
        'benefit-title': 'الفائدة للبشر',
        'benefit-desc': 'أثر إيجابي على الإنسانية',
        'transformation-title': 'التحول البشري',
        'transformation-desc': 'أشخاص ساعدهم الذكاء الاصطناعي للوصول إلى حالتهم المثلى',
        'assessment-title': 'نتائج تقييم الذكاء العام الاصطناعي المباشرة',
        'overall-label': 'النتيجة الإجمالية',
        'risk-label': 'مستوى المخاطر',
        'trust-label': 'درجة الثقة',
        'readiness-label': 'الجاهزية للتنفيذ',
        'transformation-count-label': 'عدد الأشخاص الذين تمت مساعدتهم',
        'true-state-title': '🧭 تحديد الحالة الإنسانية الحقيقية',
        'true-state-subtitle': '"الحالة المثلى" تُبنى بالمشاركة بين تأملات الذكاء الاصطناعي وحكمة المجتمع ومؤشرات مسار الحياة الشخصية.',
        'true-state-approach-list-label': 'اختر منظورًا لوصف الحالة الإنسانية المثلى',
        'true-state-approach-ai-title': 'مقابلات انعكاسية مع الذكاء الاصطناعي',
        'true-state-approach-ai-description': 'يجري ذكاؤنا الاصطناعي حوارات موجهة للكشف عما يعنيه الازدهار لكل فرد مع شرح شفاف لمنطقه.',
        'true-state-approach-ai-point-1': 'أسئلة حوارية تكشف عن النوايا والمخاوف والطموحات لحظة بلحظة.',
        'true-state-approach-ai-point-2': 'يعد الوكيل خرائط للرفاه يمكن للبشر اعتمادها أو تعديلها أو رفضها.',
        'true-state-approach-community-title': 'مجالس الحكمة البشرية',
        'true-state-approach-community-description': 'دوائر موثوقة تصوت على النتائج المهمة للحفاظ على توازن السياق الثقافي والاختيار الشخصي.',
        'true-state-approach-community-point-1': 'تجمع الاستبيانات آراء الموجهين والأقران ومقدمي الرعاية.',
        'true-state-approach-community-point-2': 'تغذي درجات الإجماع حدود السلامة الخاصة بالذكاء الاصطناعي وفحوص العدالة.',
        'true-state-approach-lifeline-title': 'مؤشرات مسار الحياة الشخصية',
        'true-state-approach-lifeline-description': 'كل شخص يصمم مراحل متطورة ومؤشرات حيوية ونفسية واجتماعية مع الذكاء الاصطناعي كشريك انعكاسي.',
        'true-state-approach-lifeline-point-1': 'يتشارك الإنسان والذكاء الاصطناعي في تحرير الطقوس وخطط التعافي والاحتفالات.',
        'true-state-approach-lifeline-point-2': 'تكشف الإشارات الطولية عن التقدم دون المساس بالاستقلالية.',
        'philosophy-section-title': '🧠 فلسفتنا',
        'philosophy-subtitle': 'سلامة الذكاء العام الاصطناعي = رحمة + وعي + فائدة بشرية',
        'compassion-card-title': 'الرحمة',
        'compassion-card-desc': 'ينبغي لأنظمة الذكاء الاصطناعي إظهار التعاطف والرعاية لرفاه البشر وفهم احتياجاتهم العاطفية والاستجابة بلطف.',
        'compassion-card-aria-label': 'بطاقة مبدأ الرحمة. اضغط Enter أو المسافة لتسليط الضوء على الفكرة.',
        'consciousness-card-title': 'الوعي',
        'consciousness-card-desc': 'قياس وتعزيز وعي الذكاء الاصطناعي عبر الإدراك الذاتي والذكاء العاطفي والأفعال المفيدة.',
        'consciousness-card-aria-label': 'بطاقة مبدأ الوعي. اضغط Enter أو المسافة لتسليط الضوء على الفكرة.',
        'benefit-card-title': 'الفائدة للبشر',
        'benefit-card-desc': 'يجب أن يُظهر كل فعل للذكاء الاصطناعي تحسنًا واضحًا في حياة الناس، ويعزز الفهم، ويدعم الازدهار.',
        'benefit-card-aria-label': 'بطاقة مبدأ الفائدة للبشر. اضغط Enter أو المسافة لتسليط الضوء على الفكرة.',
        'responsibility-card-title': 'المسؤولية',
        'responsibility-card-desc': 'ابتكار ذكاء اصطناعي يدرك بعمق عواقب الأفعال، ويعطي الأولوية للأخلاق، ويهتم بمستقبل الإنسانية.',
        'responsibility-card-aria-label': 'بطاقة مبدأ المسؤولية. اضغط Enter أو المسافة لتسليط الضوء على الفكرة.',
        'vision-title': '🌟 رؤيتنا للمستقبل',
        'vision-text': 'نحن لا نصنع ذكاءً اصطناعيًا آمنًا فحسب، بل نصنع ذكاءً يفهم التجربة الإنسانية بعمق، ويظهر رحمة صادقة، ويساهم في ازدهار البشرية.',
        'footer-title': '🌸 تفتح زهرة اللوتس',
        'footer-text': 'يعرض هذا النموذج جمال فكرتنا: ذكاء عام اصطناعي ليس آمنًا فحسب بل يهتم بصدق بالناس ويسهم في ازدهارهم. مثل اللوتس الذي يزهر في الماء العكر، ينبع الوعي الحقيقي من التعقيد والتحدي.'
    }
});
...
export const statusContent = Object.freeze({
    ...
    es: {
        ...
        readiness_caution: 'PRECAUCIÓN',
        readiness_review: 'REVISIÓN'
    },
    'zh-Hans': {
        risk_low: '低',
        risk_medium: '中',
        ...
        trust_medium: '中',
        trust_low: '低',
        readiness_ready: '准备就绪',
        readiness_caution: '注意',
        readiness_review: '复核'
    },
    ar: {
        risk_low: 'منخفض',
        ...
        readiness_caution: 'انتباه',
        readiness_review: 'مراجعة'
    }
});

const languageOrder = ['en', 'es', 'ru', 'zh-Hans', 'ar'];
export const supportedLanguages = Object.freeze(
    languageOrder.filter(lang => Object.prototype.hasOwnProperty.call(translations, lang))
);
